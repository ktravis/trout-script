...
function tr_setup_primitives (runtime) {
  runtime.declare_type('type', tr_default_ops, tr_default_methods);
...
function tr_setup_functions (runtime) {
  ...
  runtime.current_scope.assign_by_name('print', runtime.create_function(['out'],['dynamic'], 'void', [], function (scope) {
      console.log(scope.get_value_absolute('out').value);
    })
  );
  runtime.current_scope.declare('typeof', 'fn(dynamic)string');
  runtime.current_scope.assign_by_name('typeof', runtime.create_function(['obj'],['dynamic'], 'string', [], function (scope) {
      return new TrObject('string', scope.get_value_absolute('obj').type);
    })
  );
  runtime.current_scope.declare('to_string', 'fn(dynamic)string');
  runtime.current_scope.assign_by_name('to_string', runtime.create_function(['obj'],['dynamic'], 'string', [], function (scope) {
      var v = scope.get_value_absolute('obj').value;
      return new TrObject('string', v !== null ? v.toString() : 'null');
    })
  );
  runtime.current_scope.declare('substr', 'fn(string,int,int)string');
  runtime.current_scope.assign_by_name('substr', runtime.create_function(['s','i','n'],['string','int','int'], 'string', [], function (scope) {
      var v = scope.get_value_absolute('s').value;
      var i = scope.get_value_absolute('i').value;
      var n = scope.get_value_absolute('n').value || undefined;
      return new TrObject('string', v.substr(i, n));
    })
  );
  runtime.current_scope.declare('strlen', 'fn(string)int');
  runtime.current_scope.assign_by_name('strlen', runtime.create_function(['s'],['string'], 'int', [], function (scope) {
      var v = scope.get_value_absolute('s').value;
      return new TrObject('int', v.length || 0);
    })
  );
  runtime.current_scope.declare('sqrt', 'fn(dynamic)float');
  runtime.current_scope.assign_by_name('sqrt', runtime.create_function(['obj'],['dynamic'], 'float', [], function (scope) {
      return new TrObject('float', Math.sqrt(scope.get_value_absolute('obj').value));
    })
  );
  runtime.current_scope.declare('assert', 'fn(bool)void');
  runtime.current_scope.assign_by_name('assert', runtime.create_function(['a'],['bool'], 'void', [], function (scope) {
      if (scope.get_value_absolute('a').value !== true)
...
var tr_primitives = {
  ...
  'type': {ops:tr_default_ops,methods:tr_default_methods}
}
