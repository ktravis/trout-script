...
TrFunction.prototype.call_function = function (args) {
	...
	for (var i = 0; i < args.length; i++) {
		...
		// this.scope.assign_variable(a,args[i]); // compiler handles transformation of arguments into copies / refs if needed
		execution_scope.declare(a,t);
		execution_scope.assign_variable(a,args[i]); // compiler handles transformation of arguments into copies / refs if needed
	}
